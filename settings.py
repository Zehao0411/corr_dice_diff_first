...
SESSION_CONFIGS = [dict(
    ...
    app_sequence=['start_page', 'diff_dice', 'same_dice', 'questionnaire', 'reward_page']
...
ROOMS = [dict(name='CCBEF404A', display_name='颐德楼404A', participant_label_file='_rooms/CCBEF404A.txt')]
